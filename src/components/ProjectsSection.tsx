  ...
  const projects = [
    {
      ...
      image: '/kelselyay.png',
      technologies: ['Next.js', 'Javascript', 'MongoDB Atlas', 'Mapbox API', 'AWS S3'],
    ...
    },
    {
      ...
      image: '/journeyAI.png',
      technologies: ['React.js', 'Gemini API', 'MapBox API', 'Tailwind CSS', 'Firebase'],
    ...
    },
    {
      ...
      technologies: ['React.js', 'Typescript', 'Socket.io', 'Postgresql', 'Tailwind CSS'],
