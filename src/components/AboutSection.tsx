...
const AboutSection = () => {
  ...
  const roadtripPhotos = [
    { src: "/IMG_2754 2.JPG", alt: "Mountain adventure with friends", location: "Yosemite National Park" },
    { src: "/IMG_1079.jpg", alt: "Sunset moments", location: "La Jolla Cove" },
    { src: "/clubRush.JPG", alt: "City exploration", location: "PI Day Celebration" },
    { src: "/clubActivity.JPG", alt: "Canyon", location: "Coding Workshop" },
  ];
